...
function install(A,root){
 ...
 function injectCss(){
  ...
  if(!$('quality28WorkstationCss')){var w=d.createElement('link');w.id='quality28WorkstationCss';w.rel='stylesheet';w.href='quality28-workstation.css?v=q28-workstation-1';d.head.appendChild(w);}
 }
