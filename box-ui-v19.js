...
function compactPreSnap(){
 ...
 if(motionWrap){var ml=motionWrap.querySelector('.label');if(ml)ml.innerHTML='Motion <span class="optional">optional</span>'}
...
function prepare(){d.documentElement.classList.add('fniqBoxCompact');compactPreSnap();inlinePenalty();tightenLabels()}
injectCss();prepare();
})(window);
