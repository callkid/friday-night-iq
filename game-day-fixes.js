...
function install(A,root){
  ...
  function installSaveScroll(){
    ...
    save.onclick=function(e){var before=A.state.plays.length,r=old&&old.call(this,e),added=A.state.plays.length>before;if(added){setTimeout(scrollToLiveTop,160);setTimeout(scrollToLiveTop,380);}return r;};
  }
