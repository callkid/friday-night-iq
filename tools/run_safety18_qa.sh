...
run_shell "Historical UX contract" 'grep -q "DELAY=3200" tooltip-polish.js && grep -q "Save for quick access" game-iq-polish.js && grep -q "Returned for TD" pick-six.js && grep -q "explosiveRun" analytics.js && grep -q "explosivePass" analytics.js'
