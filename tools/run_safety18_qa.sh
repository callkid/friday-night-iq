...
run_shell "Safety22 release architecture" 'grep -q "tooltip-polish.js" app.js && grep -q "penalty-hardening.js" app.js && grep -q "pick-six.js" app.js && grep -q "live-correction.js" app.js && grep -q "box-ui-v19.js" app.js && grep -q "game-iq-summary.js" app.js && ! grep -q "game-day-3.js" app.js && ! grep -q "speed-guard.js" app.js && ! grep -q "game-iq-v3.js" app.js && grep -q "v=safety22" app.js && grep -q "app.js?v=safety22" index.html && grep -q "box-ui-v19.css?v=box22" box-ui-v19.js && grep -q "visual-polish.css?v=visual22" box-ui-v19.js && grep -q "pick-six.css?v=pick22" pick-six.js && grep -q "fniq_prod_v1" state.js && grep -q "fniq_recovery_v1" durability.js'
