...
A.setContext=function(c){A.state.context=A.state.context||context();if(c&&c.formation!=null)A.state.context.formation=c.formation||'NA';if(c&&c.personnel!=null)A.state.context.personnel=c.personnel||'';A.save()};
