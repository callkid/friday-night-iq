...
(async()=>{
 ...
 console.log('QUALITY26 UNDER Q27 PASS: Edit Situation, contextual penalty, Holding enforcement, dead-ball repeat, half-distance, override, cancel, readable pinned controls, and short-laptop football workflow all operate on real saved state');
