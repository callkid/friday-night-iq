...
let pen=accepted('Holding',{effect:'COUNT'}),p=Q.normalizePenaltyPlay(play({down:1,distance:10,fieldSide:'OPP',yardLine:47},pen));
...
p=Q.normalizePenaltyPlay(play({down:1,distance:10,fieldSide:'OWN',yardLine:8},accepted('Holding',{effect:'COUNT'})));
...
p=Q.normalizePenaltyPlay(play({down:1,distance:10,fieldSide:'OWN',yardLine:25},accepted('Holding',{effect:'COUNT',netOverride:-7})));
