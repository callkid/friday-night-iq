...
(async()=>{
 ...
 assert.equal(errors.length,0,'browser errors: '+errors.join(' | '));console.log('QUALITY27 BROWSER PASS: coach pins, responsive control size, actionable missing fields, and just-saved correction access work without changing football state semantics');
