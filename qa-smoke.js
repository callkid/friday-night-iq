...
check('false start',{...base,playType:'Penalty',yards:0,penalty:{status:'Accepted',team:'Offense',yards:-5,effect:'REPEAT'}},[1,15,'OWN',20,false]);
check('3rd and 2 defensive offsides earns first down',{...base,down:3,distance:2,playType:'Penalty',yards:0,penalty:{status:'Accepted',team:'Defense',yards:5,effect:'REPEAT'}},[1,10,'OWN',30,false]);
check('live hold net +2',{...base,playType:'Run',yards:12,penalty:{status:'Accepted',team:'Offense',yards:2,effect:'COUNT'}},[2,8,'OWN',27,false]);
check('automatic first',{...base,down:2,distance:8,playType:'Pass',yards:0,penalty:{status:'Accepted',team:'Defense',yards:5,effect:'AUTO1'}},[1,10,'OWN',30,false]);
